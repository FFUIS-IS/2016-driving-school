...
{
    public partial class DeletionCandidate : Form
    {
        SqlConnection conn = new SqlConnection(Form1.path);
        SqlCommand command = new SqlCommand("");
        SqlDataReader reader;

        public DeletionCandidate()
        {
            InitializeComponent();
        }

        private void DeletionCandidate_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (validEnter)
                {
                    ...
                    {
                        command.CommandText = "DELETE FROM Candidate WHERE id = " + id + ";";
