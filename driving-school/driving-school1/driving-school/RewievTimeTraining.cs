...
{
    public partial class RewievTimeTraining : Form
    {
        public RewievTimeTraining()
        {
            InitializeComponent();
        }

        private void RewievTimeTraining_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                while (rdr.Read())
                {
                    ...
                    identity[5] = rdr.GetDateTime(2).ToString();
                    rdr.Close();
                    ...
                    reader = command2.ExecuteReader();
                    reader.Read();
                    data = "Date: " + identity[0] + "\t Candidate: " + candidate + "\t Instructor: " + instructor + "\t Car: " + "Date: " + identity[5] + reader.GetString(0);
